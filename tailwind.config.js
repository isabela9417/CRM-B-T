	...
	theme: {
		...
		extend: {
			colors: {
				...
				comment: {
					background: 'hsl(var(--comment-background))',
					border: 'hsl(var(--comment-border))',
					hover: 'hsl(var(--comment-hover))',
					author: 'hsl(var(--comment-author))',
					time: 'hsl(var(--comment-time))'
				},
				status: {
					...
					'escalated-bg': 'hsl(var(--status-escalated-bg))'
				}
			},
			borderRadius: {
				lg: 'var(--radius)',
